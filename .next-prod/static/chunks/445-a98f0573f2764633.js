...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [445],
  {
    '(app-pages-browser)/./src/app/contexts/SupabaseContext.jsx': function (e, t, s) {
      s.d(t, {
        $4: function () {
          return p;
        },
      ...
      var o = s('(app-pages-browser)/./node_modules/next/dist/compiled/react/jsx-runtime.js'),
        i = s('(app-pages-browser)/./node_modules/next/dist/compiled/react/index.js'),
        n = s('(app-pages-browser)/./node_modules/uuid/dist/esm-browser/v4.js'),
        r = s('(app-pages-browser)/./src/app/utils/supabase.js');
      ...
      function a(e) {
        ...
        (0, i.useEffect)(() => {
          (async () => {
            try {
              ...
              let {
                data: { session: e },
                error: t,
              } = await r.ZP.auth.getSession();
              if (t) throw (console.error('Error getting session:', t), t);
              if ((a((null == e ? void 0 : e.user) || null), !(null == e ? void 0 : e.user))) {
                let e = localStorage.getItem('sessionId');
                e || ((e = (0, n.Z)()), localStorage.setItem('sessionId', e)), c(e);
              }
            } catch (e) {
          ...
          let {
            data: { subscription: e },
          } = r.ZP.auth.onAuthStateChange(async (e, t) => {
            a((null == t ? void 0 : t.user) || null), l(!1);
          });
          return () => {
            e.unsubscribe();
          };
        ...
        let m = async (e, t) => {
            try {
              let { data: s, error: o } = await r.ZP.auth.signUp({ email: e, password: t });
              if (o) throw o;
              return { success: !0, data: s };
            } catch (e) {
              return console.error('Error signing up:', e), { success: !1, error: e };
            }
          },
          g = async (e, t) => {
            try {
              let { data: s, error: o } = await r.ZP.auth.signInWithPassword({
                email: e,
                password: t,
              });
              if (o) throw o;
              ...
              return console.error('Error signing in:', e), { success: !1, error: e };
            }
          },
          h = async () => {
            try {
              let { error: e } = await r.ZP.auth.signOut();
              if (e) throw e;
              return { success: !0 };
            } catch (e) {
              return console.error('Error signing out:', e), { success: !1, error: e };
            }
          },
          b = async e => {
            try {
              let { data: t, error: s } = await r.ZP.auth.resetPasswordForEmail(e, {
                redirectTo: ''.concat(window.location.origin, '/reset-password'),
              });
              if (s) throw s;
              return { success: !0, data: t };
            } catch (e) {
              return console.error('Error resetting password:', e), { success: !1, error: e };
            }
          },
          w = async e => {
            try {
              let { data: t, error: s } = await r.ZP.auth.updateUser({ password: e });
              if (s) throw s;
              return { success: !0, data: t };
            } catch (e) {
              return console.error('Error updating password:', e), { success: !1, error: e };
            }
          };
      ...
      function p() {
        ...
        if (void 0 === e) throw Error('useSupabase must be used within a SupabaseProvider');
        return e;
      }
    },
    '(app-pages-browser)/./src/app/hooks/useMbtiTest.js': function (e, t, s) {
      s.d(t, {
        Z: function () {
          return I;
        },
      });
      var o = s('(app-pages-browser)/./node_modules/next/dist/compiled/react/index.js'),
        i = s('(app-pages-browser)/./node_modules/next/dist/api/navigation.js'),
        n = s('(app-pages-browser)/./node_modules/zustand/esm/index.mjs'),
        r = s('(app-pages-browser)/./node_modules/zustand/esm/middleware.mjs'),
        u = s('(app-pages-browser)/./src/app/utils/mbtiAnalyzer.js');
      let a = (0, n.Ue)(
        (0, r.tJ)(
          (e, t) => ({
            questions: [],
            ...
            isTestCompleted: !1,
            sessionId: null,
            setQuestions: t => e({ questions: t }),
            setCurrentQuestionIndex: t => e({ currentQuestionIndex: t }),
            goToNextQuestion: () => {
              let { currentQuestionIndex: s, questions: o } = t();
              s < o.length - 1 && e({ currentQuestionIndex: s + 1 });
            },
            goToPreviousQuestion: () => {
              let { currentQuestionIndex: s } = t();
              s > 0 && e({ currentQuestionIndex: s - 1 });
            },
            goToQuestion: s => {
              let { questions: o } = t();
              s >= 0 && s < o.length && e({ currentQuestionIndex: s });
            },
            addResponse: (s, o) => {
              let { responses: i } = t();
              e({ responses: { ...i, [s]: o } });
            ...
            removeResponse: s => {
              let { responses: o } = t(),
                i = { ...o };
              delete i[s], e({ responses: i });
            },
            clearResponses: () => e({ responses: {} }),
            calculateResult: () => {
              let { questions: s, responses: o } = t(),
                i = Object.entries(o).map(e => {
                  let [t, s] = e;
                  return { questionId: parseInt(t), answer: s };
                }),
                n = (0, u.wy)(s, i);
      ...
      var p = s('(app-pages-browser)/./node_modules/@supabase/supabase-js/dist/module/index.js'),
        l = s('(app-pages-browser)/./src/app/utils/sampleQuestions.js');
      let d = e =>
          e.map(e => ({
            id: e.id,
            question: e.question,
        ...
        m = async () => {
          try {
            let { data: e, error: t } = await c.getAllQuestions();
            if (t) throw (console.error('Error fetching questions from Supabase:', t), t);
            return d(e);
          } catch (e) {
        ...
        b = async function (e, t, s) {
          let o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null;
          try {
            let { data: i, error: n } = o
              ? await c.saveUserResponse(o, t, s)
              : await c.saveAnonymousResponse(e, t, s);
      ...
      var w = s('(app-pages-browser)/./src/app/utils/mbti.js'),
        v = s('(app-pages-browser)/./src/app/contexts/SupabaseContext.jsx');
      function I() {
        let { useSampleData: e = !1, autoSave: t = !0 } =
          ...
          W = (0, o.useCallback)(() => (0 === y.length ? null : y[q]), [y, q]),
          X = (0, o.useCallback)(
            async (e, s) => {
              let o = W();
              if (o) {
                if ((F(o.id, s), t && (B || I)))
                  try {
                    await b(B, o.id, s, null == I ? void 0 : I.id);
                  } catch (e) {
            ...
            [W, F, t, B, I, q, y.length, E]
          ),
          D = (0, o.useCallback)(async () => {
            let e = N();
            if (e && e.mbtiType) {
              d((0, w.BW)(e.mbtiType)), m((0, w.cQ)(e.mbtiType));
              try {
                await (0, u.TW)(e, null == I ? void 0 : I.id, B);
              } catch (e) {
          ...
          Y = (0, o.useCallback)(() => {
            Z(), g.push('/test/question');
          }, [Z, g]),
          L = (0, o.useCallback)(() => {
            R(), d(null), m(null), g.push('/test');
          }, [R, g]);
        return (
          (0, o.useEffect)(() => {
            0 === y.length ? V() : n(!1);
          ...
          (0, o.useEffect)(() => {
            A && A.mbtiType && !l && (d((0, w.BW)(A.mbtiType)), m((0, w.cQ)(A.mbtiType)));
          }, [A, l]),
          {
            loading: s,
            error: r,
            ...
            idealType: l,
            worstMatch: c,
            mbtiResult: null == A ? void 0 : A.mbtiType,
            fetchQuestions: V,
            saveAnswer: X,
            goToNextQuestion: E,
            goToPreviousQuestion: Q,
    ...
    '(app-pages-browser)/./src/app/utils/sampleQuestions.js': function (e, t) {
      t.Z = [
        {
          id: 1,
