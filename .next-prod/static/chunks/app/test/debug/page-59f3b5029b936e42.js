(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [674],
  {
    '(app-pages-browser)/./node_modules/next/dist/build/webpack/loaders/next-flight-client-entry-loader.js?modules=%7B%22request%22%3A%22C%3A%5C%5CUsers%5C%5C%EC%A0%84%EC%A4%80%EC%98%81%5C%5CDocuments%5C%5Caugment-projects%5C%5CMBTI%20test%20for%20dating%5C%5Csrc%5C%5Capp%5C%5Ctest%5C%5Cdebug%5C%5Cpage.jsx%22%2C%22ids%22%3A%5B%5D%7D&server=false!':
      function (i, e, o) {
        Promise.resolve().then(o.bind(o, '(app-pages-browser)/./src/app/test/debug/page.jsx'));
      },
    '(app-pages-browser)/./src/app/test/debug/page.jsx': function (i, e, o) {
      'use strict';
      o.r(e),
        o.d(e, {
          default: function () {
      ...
      var s = o('(app-pages-browser)/./node_modules/next/dist/compiled/react/jsx-runtime.js'),
        t = o('(app-pages-browser)/./node_modules/next/dist/compiled/react/index.js'),
        n = o('(app-pages-browser)/./node_modules/@mui/material/Typography/Typography.js'),
        r = o('(app-pages-browser)/./node_modules/@mui/material/Paper/Paper.js'),
        d = o('(app-pages-browser)/./node_modules/@mui/material/Box/Box.js'),
        p = o('(app-pages-browser)/./node_modules/@mui/material/Button/Button.js'),
        a = o('(app-pages-browser)/./node_modules/@mui/material/List/List.js'),
        c = o('(app-pages-browser)/./node_modules/@mui/material/ListItem/ListItem.js'),
        l = o('(app-pages-browser)/./node_modules/@mui/material/ListItemText/ListItemText.js'),
        u = o('(app-pages-browser)/./node_modules/@mui/material/Divider/Divider.js'),
        m = o('(app-pages-browser)/./src/app/components/layout/index.js'),
        x = o('(app-pages-browser)/./src/app/utils/sampleQuestions.js'),
        A = o('(app-pages-browser)/./src/app/utils/mbtiAnalyzer.js');
      let B = i => {
          let e = {
            E: i.includes('E') ? 'A' : 'B',
            I: i.includes('I') ? 'A' : 'B',
        ...
        j = i => {
          let e = B(i),
            o = (0, A.wy)(x.Z, e);
          return (
            console.log('예상 MBTI: '.concat(i)),
            console.log('계산된 MBTI: '.concat(o.mbtiType)),
            console.log('일치 여부: '.concat(o.mbtiType === i ? '✅ 일치' : '❌ 불일치')),
            console.log('점수:', o.scores),
            o
          );
        };
      function C() {
        let [i, e] = (0, t.useState)(null),
          [o, x] = (0, t.useState)(null),
          [A, B] = (0, t.useState)(!1),
          C = i => {
            B(!0),
              setTimeout(() => {
                try {
                  ...
                  e({
                    expectedType: i,
                    calculatedType: o.mbtiType,
                    match: o.mbtiType === i,
                    scores: o.scores,
                  });
                } catch (i) {
                  console.error('테스트 실행 중 오류 발생:', i);
                } finally {
                  B(!1);
                }
              }, 100);
        ...
        return (0, s.jsx)(m.Xg, {
          children: (0, s.jsxs)(m.$0, {
            children: [
              (0, s.jsx)(n.Z, {
                variant: 'h4',
                sx: { mb: 4 },
                children: 'MBTI 계산 디버그 페이지',
              }),
              (0, s.jsxs)(r.Z, {
                sx: { p: 3, mb: 4 },
                children: [
                  (0, s.jsx)(n.Z, {
                    variant: 'h6',
                    sx: { mb: 2 },
                    children: '단일 MBTI 유형 테스트',
                  }),
                  (0, s.jsx)(d.Z, {
                    sx: { display: 'flex', flexWrap: 'wrap', gap: 1, mb: 3 },
                    children: ['ENFP', 'INTJ', 'ISFJ', 'ESTP'].map(i =>
                      (0, s.jsxs)(
                        p.Z,
                        {
                          variant: 'outlined',
                  ...
                  i &&
                    (0, s.jsxs)(d.Z, {
                      ...
                      children: [
                        (0, s.jsxs)(n.Z, {
                          variant: 'subtitle1',
                          children: ['예상 MBTI: ', i.expectedType],
                        }),
                        (0, s.jsxs)(n.Z, {
                          variant: 'subtitle1',
                          children: ['계산된 MBTI: ', i.calculatedType],
                        }),
                        (0, s.jsxs)(n.Z, {
                          variant: 'subtitle1',
                          children: ['일치 여부: ', i.match ? '✅ 일치' : '❌ 불일치'],
                        }),
                        (0, s.jsx)(n.Z, { variant: 'subtitle1', sx: { mt: 1 }, children: '점수:' }),
                        (0, s.jsxs)(a.Z, {
                          dense: !0,
                          children: [
                            (0, s.jsx)(c.ZP, {
                              children: (0, s.jsx)(l.Z, {
                                primary: 'E: '
                                  .concat(i.scores.E.toFixed(2), ' vs I: ')
                                  .concat(i.scores.I.toFixed(2)),
                              }),
                            }),
                            (0, s.jsx)(c.ZP, {
                              children: (0, s.jsx)(l.Z, {
                                primary: 'S: '
                                  .concat(i.scores.S.toFixed(2), ' vs N: ')
                                  .concat(i.scores.N.toFixed(2)),
                              }),
                            }),
                            (0, s.jsx)(c.ZP, {
                              children: (0, s.jsx)(l.Z, {
                                primary: 'T: '
                                  .concat(i.scores.T.toFixed(2), ' vs F: ')
                                  .concat(i.scores.F.toFixed(2)),
                              }),
                            }),
                            (0, s.jsx)(c.ZP, {
                              children: (0, s.jsx)(l.Z, {
                                primary: 'J: '
                                  .concat(i.scores.J.toFixed(2), ' vs P: ')
                                  .concat(i.scores.P.toFixed(2)),
                              }),
                            }),
                          ],
                        }),
                      ...
                      B(!0),
                        setTimeout(() => {
                          try {
                            ...
                            i.forEach(i => {
                              let s = j(i);
                              (e[i] = { calculated: s.mbtiType, match: s.mbtiType === i }),
                                s.mbtiType === i && o++;
                            }),
                              x({
                                results: e,
                                matchCount: o,
                                accuracy: Math.round((o / i.length) * 100),
                              });
                          } catch (i) {
                            console.error('모든 유형 테스트 중 오류 발생:', i);
                          } finally {
                            B(!1);
                          }
                        }, 100);
                    ...
                    (0, s.jsxs)(d.Z, {
                      ...
                      children: [
                        (0, s.jsxs)(n.Z, {
                          variant: 'subtitle1',
                          sx: { mb: 2 },
                          children: ['정확도: ', o.matchCount, '/16 (', o.accuracy, '%)'],
                        }),
                        (0, s.jsx)(u.Z, { sx: { mb: 2 } }),
                        (0, s.jsx)(n.Z, {
                          variant: 'subtitle1',
                        ...
                        (0, s.jsx)(a.Z, {
                          dense: !0,
                          children: Object.entries(o.results).map(i => {
                            let [e, o] = i;
                            return (0, s.jsx)(
                              c.ZP,
                              {
    ...
    '(app-pages-browser)/./src/app/utils/sampleQuestions.js': function (i, e) {
      'use strict';
      e.Z = [
        {
          id: 1,
  ...
  function (i) {
    i.O(0, [631, 934, 818, 150, 330, 880, 971, 117, 744], function () {
      return i(
        (i.s =
          '(app-pages-browser)/./node_modules/next/dist/build/webpack/loaders/next-flight-client-entry-loader.js?modules=%7B%22request%22%3A%22C%3A%5C%5CUsers%5C%5C%EC%A0%84%EC%A4%80%EC%98%81%5C%5CDocuments%5C%5Caugment-projects%5C%5CMBTI%20test%20for%20dating%5C%5Csrc%5C%5Capp%5C%5Ctest%5C%5Cdebug%5C%5Cpage.jsx%22%2C%22ids%22%3A%5B%5D%7D&server=false!')
      );
