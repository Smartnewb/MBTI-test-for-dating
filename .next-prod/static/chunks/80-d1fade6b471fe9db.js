...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [80],
  {
    '(app-pages-browser)/./src/app/components/mystical/index.js': function (t, a, e) {
      e.d(a, {
        py: function () {
          return h;
        },
      ...
      var r = e('(app-pages-browser)/./node_modules/next/dist/compiled/react/jsx-runtime.js'),
        n = e('(app-pages-browser)/./node_modules/styled-jsx/style.js'),
        o = e.n(n),
        i = e('(app-pages-browser)/./node_modules/next/dist/compiled/react/index.js'),
        s = e('(app-pages-browser)/./node_modules/@mui/material/Box/Box.js'),
        l = e('(app-pages-browser)/./node_modules/@mui/material/styles/styled.js');
      let p = (0, l.ZP)(s.Z)(t => {
          let { theme: a } = t;
          return {
            position: 'absolute',
            ...
            background: 'linear-gradient(135deg, '
              .concat(a.palette.primary.dark, '80 0%, ')
              .concat(a.palette.background.default, ' 100%)'),
          };
        }),
        c = (0, l.ZP)(s.Z)(t => {
          let { theme: a, size: e, top: r, left: n, delay: o, duration: i } = t;
          return {
            position: 'absolute',
            width: e,
            height: e,
            ...
            left: n,
            borderRadius: '50%',
            background: a.palette.secondary.light,
            boxShadow: '0 0 '
              .concat(e, 'px ')
              .concat(e / 2, 'px ')
              .concat(a.palette.secondary.light),
            animation: 'twinkle '.concat(i, 's ease-in-out ').concat(o, 's infinite'),
            opacity: 0.7,
          };
        }),
        d = (0, l.ZP)(s.Z)(t => {
          let { theme: a, top: e, left: r, delay: n } = t;
          return {
            position: 'absolute',
            top: e,
            left: r,
            width: '100px',
            height: '2px',
            background: 'linear-gradient(to right, transparent, '.concat(
              a.palette.secondary.light,
              ', transparent)'
            ),
            transform: 'rotate(-45deg)',
            animation: 'shootingStar 3s linear '.concat(n, 's'),
            animationFillMode: 'forwards',
            opacity: 0,
          };
        }),
        m = (0, l.ZP)(s.Z)(t => {
          let { theme: a, top: e, left: r, size: n, opacity: o, delay: i } = t;
          return {
            position: 'absolute',
            top: e,
            left: r,
            ...
            opacity: o,
            animation: 'fog '
              .concat(10 + 10 * Math.random(), 's ease-in-out ')
              .concat(i, 's infinite'),
          };
        });
      function y(t) {
        let { starCount: a = 50, shootingStarCount: e = 3, fogCount: n = 5, sx: s = {} } = t,
          [l, y] = (0, i.useState)([]),
          [g, x] = (0, i.useState)([]),
          [f, u] = (0, i.useState)([]);
        return (
          ...
          (0, r.jsxs)(p, {
            ...
            children: [
              ...
              g.map(t => (0, r.jsx)(d, { top: t.top, left: t.left, delay: t.delay }, t.id)),
              f.map(t =>
                (0, r.jsx)(
                  m,
      ...
      var g = e('(app-pages-browser)/./src/app/components/TarotCard.jsx');
      let x = (0, l.ZP)(s.Z)(t => {
          let { theme: a } = t;
          return { perspective: '1000px', width: '100%', height: '100%' };
        }),
        f = (0, l.ZP)(s.Z)(t => {
          let { theme: a, isFlipped: e } = t;
          return {
            position: 'relative',
            width: '100%',
            height: '100%',
      ...
      function h(t) {
        ...
        return (0, r.jsx)(x, {
          onClick: w,
          sx: { cursor: d ? 'pointer' : 'default', ...y },
          children: (0, r.jsxs)(f, {
            isFlipped: h,
            children: [
              (0, r.jsx)(u, {
                isFront: !0,
                children: (0, r.jsx)(g.Z, { variant: n, title: s, children: a }),
              }),
              (0, r.jsx)(u, { children: (0, r.jsx)(g.Z, { variant: o, title: l, children: e }) }),
            ],
          }),
        });
      }
      var b = e('(app-pages-browser)/./node_modules/@mui/material/Typography/Typography.js');
      (0, l.ZP)(s.Z)(t => {
        let { theme: a, size: e } = t;
        return {
          display: 'flex',
        ...
        (0, l.ZP)(s.Z)(t => {
          ...
          return {
            ...
            height: '100%',
            borderRadius: '50%',
            border: '2px solid '.concat(a.palette.primary.main, '30'),
            ...
            '&::before': {
              ...
              boxShadow: '0 0 10px '
                .concat(a.palette.primary.main, ', 0 0 20px ')
        ...
        (0, l.ZP)(s.Z)(t => {
          ...
          return {
            ...
            height: '80%',
            borderRadius: '50%',
            border: '2px solid '.concat(a.palette.secondary.main, '30'),
            ...
            '&::before': {
              ...
              height: '10px',
              borderRadius: '50%',
              background: a.palette.secondary.main,
              boxShadow: '0 0 10px '
                .concat(a.palette.secondary.main, ', 0 0 20px ')
        ...
        (0, l.ZP)(s.Z)(t => {
          ...
          return {
            ...
            '& svg': { fontSize: '2rem', color: a.palette.primary.main },
          };
        }),
        (0, l.ZP)(b.Z)(t => {
          let { theme: a } = t;
          return {
            ...
            fontWeight: a.typography.fontWeight.medium,
      ...
      (0, l.ZP)(s.Z)(t => {
        let { theme: a, size: e, variant: r } = t;
        return {
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
        ...
        (0, l.ZP)(w.Z)(t => {
          let { theme: a, variant: e, size: r } = t;
          return {
            color:
              'primary' === e
                ? a.palette.primary.main
                : 'secondary' === e
                  ...
                  : a.palette.primary.main,
            ...('mystical' === e && {
              filter: 'drop-shadow(0 0 5px '.concat(a.palette.primary.main, ')'),
            }),
          };
        }),
        (0, l.ZP)(w.Z)(t => {
          ...
          return {
            ...
            color:
              'primary' === e
                ? a.palette.primary.light
                : 'secondary' === e
                  ? a.palette.secondary.light
                  : a.palette.secondary.main,
            ...('mystical' === e && {
              filter: 'drop-shadow(0 0 5px '.concat(a.palette.secondary.main, ')'),
            }),
          };
        }),
        (0, l.ZP)(s.Z)(t => {
          let { theme: a, variant: e } = t;
          return {
            position: 'absolute',
            display: 'flex',
            alignItems: 'center',
            ...
            padding: a.spacing(1),
            ...('primary' === e && { color: a.palette.primary.main }),
            ...('secondary' === e && { color: a.palette.secondary.main }),
            ...('mystical' === e && {
              background: 'linear-gradient(135deg, '
        ...
        (0, l.ZP)(b.Z)(t => {
          ...
          return {
            ...
            ...('mystical' === e && {
              ...
              textShadow: '0 0 5px '.concat(a.palette.primary.main, '40'),
            }),
          };
        }),
        (0, l.ZP)(s.Z)(t => {
          let { theme: a, index: e } = t;
          return {
            position: 'absolute',
            width: 6,
            height: 6,
            ...
            boxShadow: '0 0 5px '.concat(a.palette.secondary.main),
            animation: 'twinkle 1.5s infinite ease-in-out '.concat(0.3 * e, 's'),
            top: ''.concat(20 + 60 * Math.random(), '%'),
            left: ''.concat(20 + 60 * Math.random(), '%'),
            transform: 'translate(-50%, -50%)',
          };
        });
      var k = e('(app-pages-browser)/./node_modules/@mui/material/Stepper/Stepper.js'),
        Z = e('(app-pages-browser)/./node_modules/@mui/material/StepConnector/StepConnector.js'),
        j = e('(app-pages-browser)/./node_modules/@mui/material/StepLabel/StepLabel.js');
      (0, l.ZP)(s.Z)(t => {
        let { theme: a } = t;
        return { width: '100%', padding: a.spacing(2, 0) };
      }),
        (0, l.ZP)(k.Z)(t => {
          let { theme: a, variant: e } = t;
          return { '& .MuiStepConnector-line': { minHeight: 12 } };
        }),
        (0, l.ZP)(Z.Z)(t => {
          let { theme: a, variant: e } = t;
          return {
            ...
            '&.Mui-active, &.Mui-completed': {
              '& .MuiStepConnector-line': {
                ...('primary' === e && { backgroundColor: a.palette.primary.main }),
                ...('secondary' === e && { backgroundColor: a.palette.secondary.main }),
                ...('mystical' === e && {
                  background: 'linear-gradient(90deg, '
                    .concat(a.palette.primary.main, ', ')
                    .concat(a.palette.secondary.main, ')'),
                  boxShadow: '0 0 8px '.concat(a.palette.primary.main, '80'),
                }),
              },
            },
          };
        ...
        (0, l.ZP)('div')(t => {
          let { theme: a, variant: e, active: r, completed: n } = t;
          return {
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            ...
            ...(n && {
              ...
              ...('secondary' === e && {
                ...
                boxShadow: '0 0 8px '.concat(a.palette.secondary.main, '80'),
              }),
              ...('mystical' === e && {
                background: 'linear-gradient(135deg, '
                  .concat(a.palette.primary.main, ', ')
                ...
                boxShadow: '0 0 10px '.concat(a.palette.primary.main, '80'),
              }),
            }),
            ...(r &&
              !n && {
                ...('primary' === e && {
                  ...
                  color: a.palette.primary.contrastText,
                  boxShadow: '0 0 8px '.concat(a.palette.primary.light, '80'),
                }),
                ...('secondary' === e && {
                  backgroundColor: a.palette.secondary.light,
                  color: a.palette.secondary.contrastText,
                  boxShadow: '0 0 8px '.concat(a.palette.secondary.light, '80'),
                }),
                ...('mystical' === e && {
                  background: 'linear-gradient(135deg, '
                    .concat(a.palette.primary.light, ', ')
                    .concat(a.palette.secondary.light, ')'),
                  color: a.palette.common.white,
                  boxShadow: '0 0 10px '.concat(a.palette.primary.light, '80'),
                  animation: 'pulse 2s infinite ease-in-out',
                }),
              }),
            ...(!r &&
        ...
        (0, l.ZP)(j.Z)(t => {
          ...
          return {
            '& .MuiStepLabel-label': {
              ...
              fontFamily: a.typography.fontFamily.secondary,
              ...(n && {
                color: 'mystical' === e ? a.palette.secondary.main : a.palette.primary.main,
                fontWeight: a.typography.fontWeight.medium,
              }),
              ...(r &&
                !n && {
      ...
      var S = e('(app-pages-browser)/./node_modules/@mui/material/IconButton/IconButton.js'),
        C = e('(app-pages-browser)/./node_modules/@mui/material/Tooltip/Tooltip.js'),
        v = e('(app-pages-browser)/./node_modules/@mui/icons-material/ArrowBack.js'),
        z = e('(app-pages-browser)/./node_modules/@mui/icons-material/ArrowForward.js'),
        P = e('(app-pages-browser)/./src/app/components/MysticalButton.jsx');
      let F = (0, l.ZP)(s.Z)(t => {
          let { theme: a, variant: e, position: r } = t;
          return {
            display: 'flex',
            justifyContent:
              'between' === r ? 'space-between' : 'center' === r ? 'center' : 'flex-start',
            alignItems: 'center',
            width: '100%',
            gap: a.spacing(2),
          };
        ...
        M = (0, l.ZP)(S.Z)(t => {
          ...
          return {
            ...
            ...('primary' === e && {
              ...
              '&:hover': { backgroundColor: ''.concat(a.palette.primary.main, '20') },
            }),
            ...('secondary' === e && {
              color: a.palette.secondary.main,
              '&:hover': { backgroundColor: ''.concat(a.palette.secondary.main, '20') },
            }),
            ...('mystical' === e && {
              color: a.palette.primary.main,
              '&:hover': {
                backgroundColor: ''.concat(a.palette.primary.main, '20'),
                boxShadow: '0 0 10px '.concat(a.palette.primary.main, '40'),
              },
            }),
            '&.Mui-disabled': { opacity: 0.5, color: a.palette.text.disabled },
          };
        });
      var R = (0, i.forwardRef)(function (t, a) {
          let {
            variant: e = 'primary',
            position: n = 'between',
            type: o = 'button',
                        ...
                        (0, r.jsx)(C.Z, {
                          ...
                          children: (0, r.jsx)('span', {
                            children: (0, r.jsx)(P.Z, {
                              variant: 'mystical' === e ? 'tarot' : 'outlined',
                              onClick: x,
                              disabled: d,
                              startIcon: (0, r.jsx)(v.Z, {}),
                              'aria-label': i,
                              children: i,
                            }),
                          }),
                        }),
                      !p && 'between' === n && (0, r.jsx)(s.Z, {}),
                      c &&
                        (0, r.jsx)(C.Z, {
                          title: g || '',
                          arrow: !!g,
                          children: (0, r.jsx)('span', {
                            children: (0, r.jsx)(P.Z, {
                              variant: 'mystical' === e ? 'mystical' : 'contained',
                              onClick: f,
                              disabled: m,
                              endIcon: (0, r.jsx)(z.Z, {}),
                              'aria-label': l,
        ...
        _ = e('(app-pages-browser)/./src/app/components/animations.jsx');
      let I = (0, l.ZP)(s.Z)(t => {
          let { theme: a, align: e } = t;
          return {
            display: 'flex',
            flexDirection: 'column',
        ...
        T = (0, l.ZP)(b.Z)(t => {
          let { theme: a, color: e, hasGradient: r } = t;
          return {
            ...
            color: r ? 'transparent' : e || a.palette.primary.main,
            ...(r && {
              background: 'linear-gradient(135deg, '
            ...
            [a.breakpoints.down('md')]: { fontSize: '2rem' },
          };
        }),
        W = (0, l.ZP)(b.Z)(t => {
          let { theme: a, color: e } = t;
          return {
            fontFamily:
              '"Pretendard", "Noto Sans KR", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif',
            fontWeight: 500,
            fontSize: '1.2rem',
            color: e || a.palette.text.secondary,
            [a.breakpoints.down('md')]: { fontSize: '1rem' },
          };
        }),
        B = (0, l.ZP)(s.Z)(t => {
          let { theme: a, align: e } = t;
      ...
      function D(t) {
        ...
        return (0, r.jsx)(_.F, {
          ...
          children: (0, r.jsxs)(I, {
            ...
            sx: d,
            children: [
              (0, r.jsx)(T, { variant: 'h2', color: o, hasGradient: l, align: n, children: a }),
              s && (0, r.jsx)(B, { align: n }),
              e && (0, r.jsx)(W, { variant: 'subtitle1', color: i, align: n, children: e }),
            ],
          }),
        });
      }
      (0, l.ZP)(s.Z)(t => {
        let { theme: a, isTyping: e, cursorColor: r } = t;
        return {
          display: 'inline-block',
          position: 'relative',
          '&::after': {
            ...
            height: '100%',
            width: '2px',
            backgroundColor: r || a.palette.primary.main,
      ...
      var L = e('(app-pages-browser)/./src/app/components/layout/index.js');
      let A = (0, l.ZP)(s.Z)(t => {
        let { theme: a, variant: e } = t,
          r = { position: 'relative', padding: a.spacing(8, 0), overflow: 'hidden' };
        return 'dark' === e
          ? { ...r, background: a.palette.background.default, color: a.palette.common.white }
          : 'light' === e
            ? { ...r, background: a.palette.background.paper, color: a.palette.text.primary }
            : 'primary' === e
              ? {
                  ...r,
                  background: 'linear-gradient(135deg, '
                    .concat(a.palette.primary.dark, '80 0%, ')
                    .concat(a.palette.primary.main, '40 100%)'),
                  color: a.palette.common.white,
                }
              : 'secondary' === e
                ? {
                    ...r,
                    background: 'linear-gradient(135deg, '
                      .concat(a.palette.secondary.dark, '80 0%, ')
                      .concat(a.palette.secondary.main, '40 100%)'),
                    color: a.palette.common.white,
                  }
                : 'mystical' === e
                  ? {
                      ...
                      background: 'linear-gradient(135deg, '
                        .concat(a.palette.primary.dark, '80 0%, ')
                        .concat(a.palette.secondary.dark, '80 100%)'),
                      color: a.palette.common.white,
                    }
      ...
      function N(t) {
        ...
        return (0, r.jsxs)(A, {
          ...
          ...m,
          children: [
            n && (0, r.jsx)(y, { starCount: o, shootingStarCount: 2, fogCount: 3 }),
            (0, r.jsx)(L.$0, {
              fullWidth: i,
              fullHeight: s,
              centered: l,
      ...
      let H = (0, l.ZP)(b.Z)(t => {
        ...
        return {
          ...
          fontFamily:
            'mystical' === o
              ? (null === (a = r.typography.fontFamily) || void 0 === a ? void 0 : a.secondary) ||
                'Cinzel, serif'
              : (null === (e = r.typography.fontFamily) || void 0 === e ? void 0 : e.primary) ||
                'Raleway, sans-serif',
          ...(s && {
            background: 'linear-gradient(135deg, '
          ...
          ...(l && {
            textShadow: '0 0 5px '
              .concat(i || r.palette.primary.main, '40, 0 0 10px ')
              .concat(i || r.palette.primary.main, '30'),
          }),
          ...(p && { textShadow: '2px 2px 4px rgba(0, 0, 0, 0.3)' }),
          ...('mystical' === o && {
            fontWeight: 700,
          ...
          ...('tarot' === o && {
            fontFamily: r.typography.fontFamily
              ? r.typography.fontFamily.secondary
              : 'Cinzel, serif',
            fontWeight: 500,
            letterSpacing: '0.1em',
          ...
          ...('quote' === o && {
            fontStyle: 'italic',
            borderLeft: '3px solid '.concat(r.palette.primary.main),
      ...
      var Y = (0, i.forwardRef)(function (t, a) {
        let {
          children: e,
          variant: n = 'body1',
          textVariant: o,
