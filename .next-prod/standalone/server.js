...
const nextConfig = {
  ...
  onDemandEntries: { maxInactiveAge: 3600000, pagesBufferLength: 5 },
  amp: { canonicalBase: '' },
  basePath: '',
  sassOptions: {},
  trailingSlash: false,
  ...
  experimental: {
    ...
    outputFileTracingRoot: 'C:\\Users\\전준영\\Documents\\augment-projects\\MBTI test for dating',
    ...
    serverActions: { allowedOrigins: ['localhost:3000', 'mbti-dating-test.vercel.app'] },
