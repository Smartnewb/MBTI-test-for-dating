 ...
 * 미스티컬 테마로 신비롭고 로맨틱한 분위기를 위한 색상 토큰입니다.
 * 주요 색상: 보라색, 금색, 네이비
 */
...
const baseColors = {
  ...
  // 가장색 계열
  black: {
    50: '#2D2D3D', // 어두운 보라색 배경 테두리
    100: '#272736',
    200: '#23232F',
    300: '#1E1E28',
    400: '#181821',
    500: '#12121A', // 주요 가장색 (어두운 보라색 배경 테두리)
    600: '#0E0E14',
    700: '#0A0A0F',
    800: '#05050A',
    900: '#000000',
...
export const colors = {
  // 주요 색상
  primary: {
    main: baseColors.purple[500], // 더 밝아진 보라색
  ...
  background: {
    ...
    elevated: baseColors.navy[400], // 높아진 요소 배경
  ...
  text: {
    ...
    accent: baseColors.gold[400], // 강조 텍스트 (금색)
    mystical: baseColors.purple[300], // 미스티컬 텍스트 (보라색)
  },
  ...
  misc: {
    ...
    glowGold: `0 0 15px ${baseColors.gold[400]}80`, // 금색 글로우 효과
