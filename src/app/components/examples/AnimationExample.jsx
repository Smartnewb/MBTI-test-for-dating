...
import { Box, Typography, Paper, Grid, Button, Divider, Stack, useTheme } from '@mui/material';
...
import { getColor } from '../../utils/safeColorAccess';
...
export default function AnimationExample() {
  ...
  const renderPageTransition = () => {
    switch (transitionEffect) {
      case 'fade':
        return <PageFade direction={direction}>{pages[currentPage]}</PageFade>;
      case 'slide':
        return <PageSlide direction={direction}>{pages[currentPage]}</PageSlide>;
      case 'zoom':
        return <PageZoom direction={direction}>{pages[currentPage]}</PageZoom>;
      case 'flip':
        return <PageFlip direction={direction}>{pages[currentPage]}</PageFlip>;
      default:
    ...
    <Box sx={{ p: 4 }}>
      ...
      <Paper sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ mb: 3 }}>
          AnimatedElement 컴포넌트는 다양한 애니메이션 효과를 제공합니다. 등장, 퇴장, 강조 등 다양한
          상황에 맞게 사용할 수 있습니다.
        </Typography>
      ...
      <Paper sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ mb: 3 }}>
          AnimatedGroup 컴포넌트는 여러 요소를 순차적으로 애니메이션화합니다. 리스트, 그리드 등 여러
          요소를 표시할 때 유용합니다.
        </Typography>
          ...
          {Array.from({ length: 5 }).map((_, index) => (
            <Box
              ...
              sx={{
                ...
                mb: 1,
                bgcolor: theme => {
                  if (index === 0) return getColor(theme, 'primary', 'light', '#8E6DB6');
                  if (index === 1) return getColor(theme, 'primary', 'main', '#6B3FA0');
                  if (index === 2) return getColor(theme, 'primary', 'dark', '#4A235A');
                  if (index === 3) return getColor(theme, 'primary', 'main', '#6B3FA0');
                  return getColor(theme, 'primary', 'dark', '#4A235A');
                },
      ...
      <Paper sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ mb: 3 }}>
          AnimatedText 컴포넌트는 다양한 텍스트 애니메이션 효과를 제공합니다. 타이핑, 글자별
          애니메이션 등 다양한 효과를 지원합니다.
        </Typography>
      ...
      <Paper sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ mb: 3 }}>
          AnimatedIcon 컴포넌트는 다양한 아이콘 애니메이션 효과를 제공합니다. 회전, 펄스, 바운스 등
          다양한 효과를 지원합니다.
        </Typography>
      ...
      <Paper sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ mb: 3 }}>
          PageTransition 컴포넌트는 페이지 간 전환 애니메이션을 제공합니다. 페이드, 슬라이드, 줌,
          플립 등 다양한 효과를 지원합니다.
        </Typography>
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <Paper sx={{ height: 200, overflow: 'hidden', mb: 2 }}>{renderPageTransition()}</Paper>
      ...
      <Paper sx={{ p: 3, mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ mb: 3 }}>
          AnimatedBackground 컴포넌트는 다양한 배경 애니메이션 효과를 제공합니다. 그라데이션,
          파티클, 물결, 별 등 다양한 효과를 지원합니다.
        </Typography>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6}>
            <Paper sx={{ height: 200, position: 'relative', overflow: 'hidden' }}>
              ...
              >
                <Typography variant="h6">파티클 배경</Typography>
              </Box>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <Paper sx={{ height: 200, position: 'relative', overflow: 'hidden' }}>
              ...
              >
                <Typography variant="h6">물결 배경</Typography>
              </Box>
            </Paper>
          </Grid>
        </Grid>
