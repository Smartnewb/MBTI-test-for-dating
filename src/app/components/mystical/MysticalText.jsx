...
// 스타일링된 텍스트 컴포넌트
const StyledText = styled(Typography)(({ theme, variant, textVariant, color, hasGradient, hasGlow, hasShadow }) => ({
  position: 'relative',
  fontFamily: textVariant === 'mystical' ? theme.typography.fontFamily.secondary : theme.typography.fontFamily.primary,
